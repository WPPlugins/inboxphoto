	...
	public function widget( $args, $instance ) {
		...
		switch ($type) {
			...
			case 'large_prints':
				...
				if ( ! empty ( $array->product->custom_image)) $widget .= '<a href="'. $order_url .'"><img itemprop="image" src="'. $array->product->custom_image .'" alt="'. $name .'" /></a>';
...
//			$category = __( 'New category', 'inboxphoto' );
		...
		?>
		<script>
		var jsonData = {"categories":<?php echo $categories_json ?>};
